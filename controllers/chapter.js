...
const addTopic = async (req, res) => {
    try {
        ...
        try {
            ...
            if (newTopic) {
                const updatedChapter = await Chapter.findByIdAndUpdate(chapterId, { $push: { topics: { name: name, topicId: newTopic._id } } }, { new: true });
...
const addVideoContent = async (req, res) => {
    try {
        ...
        const updatedChapter = await Chapter.findByIdAndUpdate(chapterId, { $push: { videos: videoLink } }, { new: true });
        if (!updatedChapter) {
